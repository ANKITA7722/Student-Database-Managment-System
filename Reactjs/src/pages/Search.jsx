...
const Search = () => {
  ...
  const handleSubmit = () => {
    let api = `http://localhost:3000/students/?stuno=${eno}`;
  ...
  const ans = mydata.map((key) => {
    return (
      <div key={key.stuno} style={{ marginBottom: "20px" }}>
        <h3>Student Number: {key.stuno}</h3>
    ...
    <>
      <center>
        ...
        <button
          ...
          onMouseOut={(e) => (e.target.style.backgroundColor = "#4CAF50")}> Submit</button>
